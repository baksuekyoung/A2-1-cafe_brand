...
MULTILINGUAL_RULE = (
    ...
    "**reading 은 english 를 그대로 베끼면 안 됩니다.**\n"
    "  한국어 사용자가 소리 내어 읽을 수 있게 **음절을 하이픈으로 나눠** 씁니다.\n"
    "  ⭕ Ongi → OWN-gee   ⭕ Comma → COM-ma   ⭕ Nook → NUUK-euh\n"
    "  ❌ Nook → NOOK (똑같이 적으면 아무것도 알려 주지 못합니다)\n"
    "  강세가 오는 음절은 대문자로, 나머지는 소문자로 쓰면 읽기 쉽습니다.\n"
